---
allowed-tools: Bash(git status:*), Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(git checkout:*), Bash(git merge:*), Bash(git diff:*), Bash(git log:*), Bash(git ls-files:*), Bash(git grep:*), Bash(git reset HEAD:*), Read, Glob, Grep, AskUserQuestion
...
1. Analyze the staged changes and create an appropriate commit message
